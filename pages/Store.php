                    ...
                    <div class="price-search-prd">
                         ...
                         <div class="card-conteiner-prd">
                              <div class="card-content-prd">
                                   <div data-range="#third" data-value-1="#second" data-value-0="#first" class="slider-prd">
                                   ...
                                   <form class="rangeslider-prd" method="POST" action="index.php?action=cuahang">
                                        <input class="min input-ranges-prd" name="min_price" type="range" min="0" max="50000" value="<?php echo $min_price; ?>" onchange="updateLabelValue(this, 'label-min-value-prd')" />
                                        <input class="max input-ranges-prd" name="max_price" type="range" min="50000" max="10000000" value="<?php echo $max_price; ?>" onchange="updateLabelValue(this, 'label-max-value-prd')" />
                                        <input style="margin-top: 50px;" type="submit" value="Lọc Giá" class="btn-prd-price" />
                                   </form>
                              </div>
                         </div>
                    </div>
                                   ...
                                   <a href="index.php?action=chitietsanpham&id=<?php echo $row['sanpham_id']; ?>">
                                        <div class="card">
                                             ...
                                             <div class="button-container">
                                                  ...
                                                  <a href="pages/addProduct.php?action=giohang&idsp=<?php echo $row['sanpham_id'] ?>" class=" cart-button button">
