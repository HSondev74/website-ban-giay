                    ...
                    <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                         ...
                         <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
                              ...
                              <div class="form-outline mb-4" style=" display: flex; justify-content: center;">
                                   <nav style="background-image:url('./images/bgr-formlogin.jpg'); background-size: cover; background-position:center center; border-radius: 50%; height: 110px; width: 110px; border: 1px solid #3b5998;">
                                        <input style="display: block;width: 100%; height: 100%; z-index: -1; opacity: 0; " type="file" id="image" name="image" multiple required />
                                   </nav>
                              </div>
                              <!-- Username input -->
                              ...
                              <div class="form-outline mb-4">
                                   ...
                                   <input type="password" id="cf-password" class="form-control form-control-lg" name="cf-password" required />
                              </div>
                              ...
                              <a class="btn btn-primary btn-lg btn-block" style="background-color: #3b5998" href="/BanGiay/admin/login.php" role="button">
